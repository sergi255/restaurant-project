<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" divide-y divide-gray-200 w-1/2 ">
                <form method = "POST" action="{{ route('admin.kategorie.update', $kategorie->id) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="sm:col-span-6">
                    <label for="nazwa" class="block text-sm font-medium text-gray-700"> Nazwa </label>
                    <div class="mt-1">
                      <input type="text" id="nazwa" name="nazwa" value="{{ $kategorie->nazwa }}" class="block w-full 
                  ...
                  <div class="sm:col-span-6 pt-5">
                    ...
                    <div>
                                <img class="w-32 h-32" src="{{ Storage::url($kategorie->zdjecie) }}">
                    </div>
                    <div class="mt-1">
                  ...
                  <div class="sm:col-span-6 pt-5">
                    ...
                    <div class="mt-1">
                      <textarea id="opis" name="opis" rows="3"  class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('opis') border-red-400 @enderror">
                      {{ $kategorie->opis }}
                      </textarea>
                    </div>
                    @error('opis')
