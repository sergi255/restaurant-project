<x-admin-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-end m-2 p-2">
            <a href= "{{route('admin.menus.create')}}" class = "px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white"> Utwórz menu </a>
        </div>
        ...
        <tbody>
            @foreach($menus as $menu) 
                    ...
                    <td class="px-6 py-4 border">
                        ...
                        <td class="px-6 py-4 border">
                           <img src = "{{Storage::url($menu->zdjecie)}}" class="w-16 h-16 rounded" >
                        </td>
                        <td class="px-6 py-4 border">
                            {{ $menu ->opis }}
                        </td>
