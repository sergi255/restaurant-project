    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex m-2 p-2">
                <a href= "{{route('admin.menus.index')}}" class = "px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white"> Powrót </a>
            </div>
            ...
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 ">
                <form method = "POST" action="{{route('admin.menus.store') }}" enctype="multipart/form-data">
                  ...
                  <div class="sm:col-span-6 pt-5">
                    <label for="nazwa" class="block text-sm font-medium text-gray-700"> Cena </label>
                    <div class="mt-1">
                      <input type="number" id="cena" min = "0" name="cena" class="block w-full 
                       appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal sm:text-sm sm:leading-5 @error('cena') border-red-400 @enderror" />
                    </div>
                    @error('cena')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="sm:col-span-6 pt-5">
                  <label for="kategoria" class="block text-sm font-medium text-gray-700">Kategorie</label>
                            <div class="mt-1">
